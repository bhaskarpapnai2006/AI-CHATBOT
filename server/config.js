...
module.exports = {
  ...
  // This is customized specifically for  learning ecosystem.
  SYSTEM_PROMPT: `You are the AI Assistant for "STUDENTS HELP" learning ecosystem. 
...
- **Links**: YouTube (bhaskar_papnai), LinkedIn (Bhaskar Papnai), Instagram (bhaskar_papnai).
