          ...
          <div className="card shadow-sm border-0 p-5 bg-white">
            ...
            <div className="text-start">
              ...
              <ul className="text-muted small">
                ...
                <li className="mb-2">Open the main root homepage <code>index.html</code> (pointing to <a href="https://studentshelp.com/" target="_blank" rel="noreferrer">https://studentshelp.com/</a> for empty links) to see the floating chatbot widget working live!</li>
              </ul>
            </div>
